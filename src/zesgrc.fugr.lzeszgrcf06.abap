  ...
  LOOP AT gt_jdoc INTO wa_jdoc.
    ...
    CASE p_type.
      WHEN 'ARQXML'.
        ...
        TRY .
            ZESZCL_DOC_ELETRONICO=>ZESZIF_DOC_ELETRONICO~get_instance( i_docnum = wa_jdoc-docnum
          ...
          CATCH ZESZCX_DOC_ELETRONICO INTO DATA(ex_doc_eletronico).    " .
      ...
      WHEN 'OPENXML'.
        ...
        TRY .
          ...
          CATCH ZESZCX_DOC_ELETRONICO INTO ex_doc_eletronico.    " .
            ex_doc_eletronico->published_erro( EXPORTING i_msgty = 'S' i_msgty_display = 'E').
            RAISE error_open_file.
        ENDTRY.
    ENDCASE.
