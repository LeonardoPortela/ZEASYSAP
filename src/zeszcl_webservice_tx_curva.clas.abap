class ZESZCL_WEBSERVICE_TX_CURVA definition
  public
  inheriting from ZESZCL_WEBSERVICE
  create public .

*"* public components of class ZESZCL_WEBSERVICE_TX_CURVA
...
public section.
  ...
  class-methods HEDGE_INSUMOS
    importing
      !I_NUMERO type ZESZSDED003 optional
  ...
  PROTECTED SECTION.
*"* protected components of class ZESZCL_WEBSERVICE_TX_CURVA
*"* do not include other source files here!!!
private section.

*"* private components of class ZESZCL_WEBSERVICE_TX_CURVA
*"* do not include other source files here!!!
...
CLASS ZESZCL_WEBSERVICE_TX_CURVA IMPLEMENTATION.
...
*    GW_XML_TAXA = ME->ZESZIF_WEBSERVICE~CONSULTAR( I_HTTP = VAR_HTTP
*                                                I_XML  = GW_XML
*                                                ).
    me->ZESZIF_WEBSERVICE~consultar( EXPORTING
                                    i_http = var_http
                                    i_xml  = gw_xml
                                  RECEIVING
