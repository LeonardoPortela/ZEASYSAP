class ZESZCX_WEBSERVICE definition
  public
  inheriting from CX_STATIC_CHECK
  create public .

*"* public components of class ZESZCX_WEBSERVICE
...
public section.
  ...
  class-methods GERA_ERRO_GERAL
    ...
    raising
      ZESZCX_WEBSERVICE .
protected section.
*"* protected components of class ZESZCX_WEBSERVICE
*"* do not include other source files here!!!
private section.
*"* private components of class ZESZCX_WEBSERVICE
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZESZCX_WEBSERVICE IMPLEMENTATION.
...
if textid is initial.
  ...
  METHOD GERA_ERRO_GERAL.
    ...
    RAISE EXCEPTION TYPE ZESZCX_WEBSERVICE
      EXPORTING
        TEXTID = VALUE #( MSGID = ZESZCX_WEBSERVICE=>ZCX_ERRO_GERAL-MSGID
                          MSGNO = ZESZCX_WEBSERVICE=>ZCX_ERRO_GERAL-MSGNO
                          ATTR1 = CONV #( SY-MSGV1 )
                          ATTR2 = CONV #( SY-MSGV2 )
                          ATTR3 = CONV #( SY-MSGV3 )
                          ATTR4 = CONV #( SY-MSGV4 ) ).
