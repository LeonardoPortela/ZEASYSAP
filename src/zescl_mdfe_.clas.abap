...
public section.
  ...
  methods ZESIF_DOC_ELETRONICO~GET_URLS_DOCS
    redefinition .
  methods ZESIF_DOC_ELETRONICO~SET_ENVIAR_CANCELAMENTO
    redefinition .
protected section.
private section.
ENDCLASS.
...
*CONTINGENCIA MDF-E - JT - 06.05.2024 =================================
  ...
  METHOD ZESIF_DOC_ELETRONICO~SET_ENVIAR_CANCELAMENTO.
    ...
    SUPER->ZESIF_DOC_ELETRONICO~SET_ENVIAR_CANCELAMENTO(
        I_RESEND = I_RESEND
    ).

*    R_INSTANCIA = ME.
*    I_JUSTIFICATIVA_CANCEL = ME->ZESIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON1 &&
*             ME->ZESIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON2 &&
*             ME->ZESIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON3 &&
*             ME->ZESIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-REASON4.
*
*    CALL FUNCTION 'Z_J_1B_MDFE_CANCEL'
*      EXPORTING
*        I_DOCNUM               = ME->ZESIF_DOC_ELETRONICO~AT_INFO_DOC_ELETRONICO-DOCNUM
**       I_MODE                 = '1'
