...
**<<<------"185281 - NMS - FIM------>>>
                                    ...
                                    zit_mdfe_infcte                         TYPE ZESZXNFE_IF_MDFE_INFCTE_300_T               "ok
                                    zit_mdfe_infnfe                         TYPE zxnfe_if_mdfe_infnfe_300_t               "ok

                                    zit_mdfe_infmdfetransp                  TYPE zxnfe_if_mdfe_infmdfetra_300_t           "ok
                                    zit_mdfe_infunidtransp                  TYPE ZESZXNFE_IF_CTE_INFUNIDTRANSP_T             "ok
                                    zit_mdfe_infunidcarga                   TYPE ZESZXNFE_IF_CTE_INFUNIDCARGA_T              "ok
                                    ...
                                    ziv_text_id_lacre                       TYPE ZESZXNFE_TEXT_REF                           "ok
...
FORM f_set_data_sefaz  USING p_data_hora  TYPE ZESZXNFE_DHEMI_UTC
...
FORM f_conv_timestamp_to_utc USING p_timestamp
                          CHANGING c_dhemi_utc TYPE ZESZXNFE_DHEMI_UTC.
