...
*DOMNAME  CHAR  30  Denominação de um domínio
*VALPOS NUMC  4 Chave de valores de um domínio
*DDLANGUAGE LANG  1 Código de idioma
*DOMVALUE_L CHAR  10  Valores p/domínios: valor ind./limite inferior
*DOMVALUE_H CHAR  10  Valores p/domínios, limite superior
*DDTEXT CHAR  60  Texto breve para valores fixos
*DOMVAL_LD  CHAR  10  Valores para domínios dependentes de idioma, limite inferior
*DOMVAL_HD  CHAR  10  Valores para domínios dependentes de idioma, limite superior
*APPVAL CHAR  1 DD: indica se um VF do apendente pertence ao append
  ...
  LOOP AT it_catalog_0101 ASSIGNING <fs_cat_0101>.
    CASE <fs_cat_0101>-fieldname.
        ...
        "  <FS_CAT_0101>-SCRTEXT_L = 'Cód'.
        "  <FS_CAT_0101>-SCRTEXT_M = 'Cód'.
        "  <FS_CAT_0101>-SCRTEXT_S = 'Cód'.
      WHEN 'DDTEXT'.
        <fs_cat_0101>-outputlen = 40.
        <fs_cat_0101>-scrtext_l = 'Descrição'.
        <fs_cat_0101>-scrtext_m = 'Descrição'.
        <fs_cat_0101>-scrtext_s = 'Descrição'.
      WHEN OTHERS.
