class ZESCX_WEBSERVICE definition
  public
  inheriting from CX_STATIC_CHECK
  create public .

*"* public components of class ZESCX_WEBSERVICE
...
public section.
  ...
  class-methods GERA_ERRO_GERAL
    ...
    raising
      ZESCX_WEBSERVICE .
protected section.
*"* protected components of class ZESCX_WEBSERVICE
*"* do not include other source files here!!!
private section.
*"* private components of class ZESCX_WEBSERVICE
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZESCX_WEBSERVICE IMPLEMENTATION.
...
if textid is initial.
  ...
  METHOD GERA_ERRO_GERAL.
    ...
    RAISE EXCEPTION TYPE ZESCX_WEBSERVICE
      EXPORTING
        TEXTID = VALUE #( MSGID = ZESCX_WEBSERVICE=>ZCX_ERRO_GERAL-MSGID
                          MSGNO = ZESCX_WEBSERVICE=>ZCX_ERRO_GERAL-MSGNO
                          ATTR1 = CONV #( SY-MSGV1 )
                          ATTR2 = CONV #( SY-MSGV2 )
                          ATTR3 = CONV #( SY-MSGV3 )
                          ATTR4 = CONV #( SY-MSGV4 ) ).
