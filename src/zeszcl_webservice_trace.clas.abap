class ZESZCL_WEBSERVICE_TRACE definition
  public
  create public .

*"* public components of class ZESZCL_WEBSERVICE_TRACE
...
public section.
  ...
  methods ENVIA_INTEGRACAO
    importing
      ...
      !ID_INTERFACE type ZESZDE_ID_INTERFACE optional .
  PROTECTED SECTION.
*"* protected components of class ZESZCL_WEBSERVICE_TRACE
*"* do not include other source files here!!!
private section.
ENDCLASS.
...
CLASS ZESZCL_WEBSERVICE_TRACE IMPLEMENTATION.
  ...
  METHOD atualiza_trace.
    ...
    IF v_author-access_token  IS NOT INITIAL.
      "//Call service
      SELECT SINGLE *
         FROM ZESZAUTH_WEBSERVICE INTO @DATA(ws_service)
...
*      ENDIF.
  ...
  METHOD envia_integracao.
    ...
    DATA: l_id     TYPE ZESZDE_ID_INTEGRACAO.
