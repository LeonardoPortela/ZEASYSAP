...
*"----------------------------------------------------------------------
  ...
  IF I_DOCNUM IS NOT INITIAL.
    ...
    IF SY-SUBRC IS NOT INITIAL.
      RAISE EXCEPTION TYPE ZESCX_DOC_ELETRONICO
        EXPORTING
          TEXTID = VALUE #( MSGID = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGID MSGNO = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGNO ATTR1 = CONV #( I_DOCNUM ) )
          MSGID  = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGID
          MSGNO  = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGNO
          MSGV1  = CONV #( I_DOCNUM )
          MSGTY  = 'E'.
    ENDIF.
  ...
  ELSEIF I_CHAVE IS NOT INITIAL.
    ...
    IF SY-SUBRC IS NOT INITIAL.
      RAISE EXCEPTION TYPE ZESCX_DOC_ELETRONICO
        EXPORTING
          TEXTID = VALUE #( MSGID = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGID MSGNO = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGNO ATTR1 = CONV #( P_CHAVE ) )
          MSGID  = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGID
          MSGNO  = ZESCX_DOC_ELETRONICO=>ZCX_DOC_CABE_NAO_ENC-MSGNO
          MSGV1  = CONV #( P_CHAVE )
          MSGTY  = 'E'.
