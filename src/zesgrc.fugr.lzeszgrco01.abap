...
*&---------------------------------------------------------------------*
*&SPWIZARD: OUTPUT MODULE FOR TS 'ZESZNFE'. DO NOT CHANGE THIS LINE!
*&SPWIZARD: SETS ACTIVE TAB
*&---------------------------------------------------------------------*
MODULE znfe_active_tab_set OUTPUT.
  ZESZNFE-activetab = g_znfe-pressed_tab.
...
*&---------------------------------------------------------------------*
*&SPWIZARD: INPUT MODULE FOR TS 'ZESZNFE'. DO NOT CHANGE THIS LINE!
