...
*"----------------------------------------------------------------------
  ...
  DATA: wl_zsdt0102     TYPE ZESZSDT0102,
  ...
  DATA: it_zlest0061 TYPE TABLE OF ZESZLEST0061,
        it_zlest0060 TYPE TABLE OF ZESZLEST0060.
  ...
  CASE i_acttab-docsta.
    WHEN ' '.    "Não Enviado
      ...
      IF i_acttab-model  EQ ZESZIF_DOC_ELETRONICO=>at_st_model_mdfe AND
        ...
        IF sy-subrc IS INITIAL.
          ...
          ZESZCL_MDFE_=>ZESZIF_DOC_ELETRONICO~get_instance( i_docnum = i_acttab-docnum
...
*** BUG - 71952 - Fim - CBRAND
        WHEN '57'.
          ...
          SELECT *
            FROM ZESZLEST0061 INTO TABLE it_zlest0061
           WHERE docnum EQ wl_doc-docnum.

          IF it_zlest0061[] IS NOT INITIAL.
            SELECT *
              FROM ZESZLEST0060 INTO TABLE it_zlest0060
            ...
            LOOP AT it_zlest0060 INTO DATA(wl_zlest0060).
              ...
              IF ( sy-subrc EQ 0 ).
                UPDATE ZESZSDT0001 SET docnum_aquav =  wl_doc-docnum
                                    ct_aquav     = 'X'
