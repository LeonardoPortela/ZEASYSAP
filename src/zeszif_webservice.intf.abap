*"* components of interface ZESZIF_WEBSERVICE
interface ZESZIF_WEBSERVICE
  public .
  ...
  data AUTENTICA_MODULE type ZESZDE_AUTENTICA_MODULE .
  ...
  class-methods GET_TOKEN_API_AD
    importing
      ...
      !I_AUTENTICA_MODULE type ZESZDE_AUTENTICA_MODULE optional
    exporting
      !E_TOKEN type STRING
    exceptions
      HTTP_COMMUNICATION_FAILURE
