class ZESZCL_WEBSERVICE_ORD_CAR definition
  public
  inheriting from ZESZCL_WEBSERVICE
  final
  create public .

*"* public components of class ZESZCL_WEBSERVICE_ORD_CAR
...
protected section.
*"* protected components of class ZESZCL_WEBSERVICE_ORD_CAR
*"* do not include other source files here!!!
private section.
*"* private components of class ZESZCL_WEBSERVICE_ORD_CAR
*"* do not include other source files here!!!
...
CLASS ZESZCL_WEBSERVICE_ORD_CAR IMPLEMENTATION.
...
*    GW_XML_TRANSP = ME->ZESZIF_WEBSERVICE~CONSULTAR( I_HTTP = VAR_HTTP
*                                                  I_XML  = GW_XML
*                                                ).
*
...
method LER_XML_TRANSP.
  ...
  DATA: IF_XML           TYPE REF TO IF_IXML,
        ...
        VL_MOTORISTA    TYPE ZESZMOTORISTA,
