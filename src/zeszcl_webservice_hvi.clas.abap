class ZESZCL_WEBSERVICE_HVI definition
  public
  create public .

*"* public components of class ZESZCL_WEBSERVICE_HVI
...
public section.
  ...
  PROTECTED SECTION.
*"* protected components of class ZESZCL_WEBSERVICE_HVI
*"* do not include other source files here!!!
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ZESZCL_WEBSERVICE_HVI IMPLEMENTATION.
