interface ZESIF_DOC_ELETRONICO
  public .


  class-data AT_INSTANCE type ref to ZESIF_DOC_ELETRONICO .
  ...
  methods GET_CK_NAO_PROC_CANCEL
    exporting
      !R_INSTANCIA type ref to ZESIF_DOC_ELETRONICO
    raising
      ZESCX_DOC_ELETRONICO .
  ...
  methods SET_AUTORIZA_VIAGEM_TIP_FRETE
    importing
      !I_ACAO type CHAR01 default ZESIF_DOC_ELETRONICO=>AT_ACAO_VIAGEM_FRETE_CRIAR
