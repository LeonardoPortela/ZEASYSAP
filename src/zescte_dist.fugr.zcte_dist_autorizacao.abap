...
*"*"Interface local:
*"  IMPORTING
*"     REFERENCE(P_CD_CHAVE_CTE) TYPE  ZESDE_CHAVE_DOC_E
*"     REFERENCE(P_TP_APROVACAO) TYPE  ZESDE_TIP_APROVACAO
*"  EXPORTING
*"     REFERENCE(P_CD_APROVACAO) TYPE  ZESDE_EST_APROVACAO
*"  CHANGING
*"     VALUE(P_TP_AUTORIZADO) TYPE  ZESDE_TP_AUTORIZACAO OPTIONAL
*"  EXCEPTIONS
*"      ERRO
*"      CTE_FINALIZADO
*"      CTE_NAO_LOC
